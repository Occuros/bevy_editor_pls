use bevy::log::info;
///This is a fork from https://github.com/JakeHandsome/egui_autocomplete with minimal modifications
/// all credit goes to the egui_autocompletes contributor for this implementation
    ...
    S: AsRef<str>,
{
    ...
    pub fn auto_select_first_entry(mut self, auto_select: bool) -> Self {
        self.auto_select_first_entry = auto_select;
        self
    }
    ...
    S: AsRef<str>,
{
    ...
    fn ui(self, ui: &mut egui::Ui) -> egui::Response {
        ...
        if auto_select_first_entry
            && ui.memory(|mem| mem.is_popup_open(id))
        ...
        if let (Some(index), true) = (
            ...
            state.selected_index = None;
            did_select_entry = true;
            info!("we are replacing");
        }
        ...
        text_response.fake_primary_click = did_select_entry;
        text_response
    }
}
